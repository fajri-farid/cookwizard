...
export default function Home() {
  return (
    <main>
      <Newhead />
      <div id="SECTION 1" className="mt-20">
        <div className="flex w-[1400px] m-auto justify-between">
          <div className="w-[750px] -space-y-20">
            <div className="font-cookWiz font-semibold text-[200px] text-cw-primary -space-y-48">
            ...
            <div className={landingStyle.textStyle}>
              ...
              <div className="ml-10 -space-y-14">
        ...
        <div className="m-auto w-[1400px]">
          <div className={landingStyle.textStyle}>
            <div>
              ...
              untuk bantu. Cukup ketik bahan yang kamu punya,
            </div>
            <div>
              dan CookWizard bakal bantuin kamu bikin resep masakan dengan
              mudah.
            </div>
          </div>
          <img
          ...
          <div className="-space-y-5 mt-10">
            ...
            <div className="ml-10">
              <div className={landingStyle.textStyle}>
                ...
                <div>2. Simpen ide masakan yang udah kamu ciptain</div>
                <div>3. Lihat resep-resep keren yang dibikin sama AI</div>
